...
finished: True
---
Heterogeneous-agent Lyapunov policy optimization (HALyPO) establishes formal stability directly in the policy-parameter space by enforcing a per-step Lyapunov decrease condition on a parameter-space disagreement metric.
